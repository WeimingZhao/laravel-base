...
@section('content')
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form method="post" class="ajaxForm form-horizontal" action="{{route('foundation.access.create')}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-5 col-lg-4">
                        <input type="text" class="form-control" name="name" required
                               placeholder="路由名称:foundation.access.create">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="control-label col-sm-2">功能名称</label>
                    <div class="col-sm-6 col-md-5 col-lg-4">
                        <input type="text" class="form-control" required name="title" placeholder="功能名称">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2">
                        <button type="submit" class="btn btn-primary btn-sm">添加功能</button>
                    </div>
                </div>
            </form>
        </div>
