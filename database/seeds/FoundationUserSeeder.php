...
class FoundationUserSeeder extends Seeder
{
    ...
    public function run()
    {
        $users = [
            ...
            ['role_id' => 2, 'username' => 'test', 'password' => '123456', 'realname' => '张主任'],
            ['role_id' => 3, 'username' => 'test2', 'password' => '123456', 'realname' => '李老师'],
            ['role_id' => 4, 'username' => 'test3', 'password' => '123456', 'realname' => '王学生'],
            ['role_id' => 5, 'username' => 'test4', 'password' => '123456', 'realname' => '王家长'],
